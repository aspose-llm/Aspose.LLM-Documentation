...
| A running project you can build and execute | A [use case](/llm/net/use-cases/) |
| Definition and behavior of a specific API or parameter | The [developer reference](/llm/net/developer-reference/) |
| A compact pattern to copy into existing code | A [quick win](/llm/net/quick-wins/) |
...
Start with the [symptom shortcut table in troubleshooting](/llm/net/troubleshooting/#symptom--page-shortcut) if you are debugging a concrete failure, or the [parameter reference](/llm/net/developer-reference/parameters/) if you need comprehensive detail on a specific knob.
