...
- `512` to `1024`: conversational replies, brief explanations.
- `2048` (default): general-purpose.
- `2048` to `4096`: reasoning-model output (Qwen3, DeepSeek-R1). Leaves room for `<think>` block plus the final answer.
...
| Scenario | Value |
|---|---|
| Classifications, yes/no | `128` to `256` |
| Conversational chat | `512` to `1024` |
| General-purpose (default) | `2048` |
| Reasoning models | `1024` to `4096` |
| Essays, code, long-form | `4096` to `8192` |
